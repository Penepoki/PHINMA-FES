        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div
                        className="flex h-full w-full md:w-1/3 flex-col items-center justify-center rounded-l-xl p-5 backdrop-blur-lg backdrop-hue-rotate-100">
                    ...
                    <div
                        className="hidden md:flex h-full w-1/3 flex-col items-center justify-center p-5 text-white backdrop-blur-lg backdrop-hue-rotate-300">
                    ...
                    <div
                        className="hidden md:flex h-full w-1/3 flex-col items-center justify-center rounded-r-xl p-5 text-white backdrop-blur-lg backdrop-hue-rotate-400">
                        {/* Title bar (tight spacing) */}
                        <div className="skeleton h-5 w-40 mb-1"/>
                        {/* Circular pie skeleton */}
                        <div className="skeleton rounded-full aspect-square w-[min(90%,220px)]"/>
    ...
    if (facultyData.length === 0) {
        return (
            <>
                ...
                <div
                    className="flex h-1/3 w-full items-center justify-center rounded-xl bg-base-100/20 p-6 sm:h-[30vh]">
            ...
            >
              ...
              <span className="text-3xl font-bold text-white">
                {currentFaculty.name}
                    ...
                    <div
                        className="hidden md:block h-full w-1/3 p-5 text-white backdrop-blur-lg backdrop-hue-rotate-300">
                        <FacultyPieChart
                    ...
                    <div
                        className="hidden md:block h-full w-1/3 rounded-r-xl p-5 text-white backdrop-blur-lg backdrop-hue-rotate-400">
                        <FacultyPieChart
