    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex h-full w-full flex-col items-center justify-center rounded-l-xl p-5 backdrop-blur-lg backdrop-hue-rotate-100 md:w-1/3">
          ...
          <div className="hidden h-full w-1/3 flex-col items-center justify-center p-5 text-white backdrop-blur-lg backdrop-hue-rotate-300 md:flex">
            <div className="skeleton mb-1 h-5 w-40" />
            <div className="skeleton aspect-square w-[min(90%,220px)] rounded-full" />
          </div>

          {/* RIGHT (md+): Teacher Pie */}
          <div className="hidden h-full w-1/3 flex-col items-center justify-center rounded-r-xl p-5 text-white backdrop-blur-lg backdrop-hue-rotate-400 md:flex">
            <div className="skeleton mb-1 h-5 w-40" />
            <div className="skeleton aspect-square w-[min(90%,220px)] rounded-full" />
          </div>
        </div>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="hidden h-full w-1/3 rounded-r-xl p-5 text-white backdrop-blur-lg backdrop-hue-rotate-400 md:block">
            <FacultyPieChart
