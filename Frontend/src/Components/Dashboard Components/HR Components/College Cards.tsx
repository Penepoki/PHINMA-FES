...
interface CollegeCardProps extends College {
    onClick?: () => void;
}
    ...
    if (onClick) {
        return (
            <div onClick={onClick} className="block cursor-pointer">
                ...
                >
                    <div
                        className="flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-tl-xl rounded-tr-xl bg-black/20 shadow-2xl">
                        <div
            ...
            <div className="mx-6 mt-6 flex h-full flex-wrap justify-center gap-6">
                {college.map((college, idx) => (
                    <div key={idx} className="w-full sm:w-1/2 lg:w-1/4">
                        <CollegeCard
                            {...college}
                            onClick={onCollegeClick ? () => onCollegeClick(college) : undefined}
                        />
                    </div>
                ))}
            </div>
