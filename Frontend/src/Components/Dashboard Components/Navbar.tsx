		...
		<>
			...
			<nav data-theme="SJC" className="relative">
				...
				{secondaryDockVisible && (
					<div
						className={`dock dock-lg bottom-23 z-[499] mx-auto w-[90%] rounded-xl shadow-xl transition-all duration-500 ease-in-out ${
							isDockVisible
				...
				{/* Primary Dock */}
				<div
					className={`dock dock-xl bottom-2 z-[500] mx-auto w-[95%] rounded-xl shadow-2xl transition-transform duration-300 ease-in-out ${
