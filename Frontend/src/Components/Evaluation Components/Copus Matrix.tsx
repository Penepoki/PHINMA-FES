...
const CopusMatrix: React.FC<CopusMatrixProps> = ({ onTalliesUpdate }) => {
  ...
  // Function to load existing timestamps
            ...
            if (!isWithinScheduleTime && canEditEvaluation) {
              return (
                  <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-4">
                    <p>This evaluation is outside the scheduled class time, but you have permission to edit it.</p>
                  </div>
              );
            }
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <button
                          ...
                          onClick={handlePrev}
                          disabled={minute === MIN_MINUTE || navigationDisabled || (!isWithinScheduleTime && !canEditEvaluation)}
                      ...
                      <button
                          className="tooltip hidden text-xl font-bold disabled:opacity-30"
                          onClick={handleNext}
                          disabled={minute === MAX_MINUTE || navigationDisabled || (!isWithinScheduleTime && !canEditEvaluation)}
                  ...
                  <div className="collapse-content">
                    ...
                    <div className="mt-4 flex justify-center">
                      <button
                          ...
                          disabled={getTotalMinutesObserved() === 0 || (!isWithinScheduleTime && !canEditEvaluation)}
                      >
                        Save Evaluation
                      </button>
                    </div>
