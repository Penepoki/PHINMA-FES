          ...
          <tr>
            <td>
              ...
              <div className="collapse-arrow collapse overflow-visible rounded-md shadow-2xl backdrop-blur-lg">
                ...
                <div className="collapse-title bg-[#1c402a]/50 text-xl font-semibold focus:ring-0 focus:outline-none">
                ...
                <div className="collapse-content flex bg-black/20 text-lg">
                  <div className="w-full">
                    ...
                    <div className="max-h-none overflow-y-auto p-2">
                      ...
                      <div className="mb-6 rounded-lg border border-[rgba(28,64,42,0.35)] bg-gradient-to-r from-[#1c402a]/40 to-[#1b2e3e]/40 p-4">
